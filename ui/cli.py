...
def start_cli():
    ...
    parser.add_argument("--filter", type=str, default=None,
                        help="Filter packet (tcp, udp, icmp, host 192.168.1.1, port 80")
    ...
    if not interface:
        return
    try:
        start_sniffing(interface, count=args.count, timeout=args.timeout, save_file=args.save, bpf_filter=args.filter)
